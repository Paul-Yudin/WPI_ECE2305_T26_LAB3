...
global STOP_WORDS  #Words at which the client/server connection will close
global HOST        #Host address
global PORT        #Port address
global ADDR        #Address
